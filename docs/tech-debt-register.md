...
**统计**：P0 **8** 项（**全部完成**）｜P1 **8** 项（**全部完成**）｜P2 **11** 项（**4 项已完成**、4 项部分完成、1 项豁免、2 项待排期）｜合计 **27** 项。

> P0 与 P1 已于 2026-09-16 清零。剩余 **8 项全部在 P2**，集中在「测试补齐」（TD-005/007/016）
